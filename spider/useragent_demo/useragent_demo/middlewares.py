...
class IpProxyDemoDownloaderMiddleware:
    PROXY = [
        "49.70.48.26:34931",
        "115.194.61.225:8118",
        "114.233.50.153:9999",
        "123.169.37.99:9999",
        "123.163.122.184:9999",
        "117.69.13.184:9999",
        "218.2.226.42:80",
        "120.83.111.153:9999",
        "113.53.255.222:8080",
        "183.166.86.7:9999",
        "117.69.200.31:9999",
        "183.146.157.187:9999",
        "114.239.149.112:9999"
    ]
    def process_request(self, request, spider):
        proxy = "http://" + random.choice(self.PROXY)
        request.meta['proxy'] = proxy

class IpProxyPrivateDownloaderMiddleware:
    def process_request(self, request, spider):
        proxy = '121.199.6.124:16816'
        user_password = "970138074:rodj35ur"
        request.meta['proxy'] = proxy
